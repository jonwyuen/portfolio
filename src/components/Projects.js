        ...
        <div className="project-section">
          <div className="project-body">
            ...
            <div className="project-detail">
              <p>
                <em>
                  Web application for learning music theory, ear training, and
                  sight reading for all instruments in a fun and effective way.
                </em>
              </p>
              ...
              <p>
                <strong>Main contribution</strong>: Developed account edit modal
                for settings menu, rendered across over 95% of front end views.
              </p>
              <p>
          ...
          <div className="project-body">
            ...
            <div className="project-detail">
              ...
              <div className="project-tech">
                Technologies Used:
                <p>
                  JavaScript, ReactJS, Python, Flask, SQLAlchemy, AWS (S3,
                  Boto), PostgreSQL
                </p>
              </div>
              <p>
                <strong>Main contribution</strong>: Implemented feature for
                doctors to upload mental health assessment videos, supporting 4X
                more media formats and reducing playlist creation time by 70%.
              </p>
              <p>
                More detailed contributions can be found on my LinkedIn/resume
              </p>
        ...
        <div className="project-section">
          <div className="project-body">
            ...
            <div className="project-detail">
              <p>
                <em>
                  Web mapping platform providing users ability to search and
                  favorite locations with current weather info and time.
                </em>
              </p>
              <div className="project-tech">
                Technologies Used:
                <p>
                  JavaScript, JQuery, HTML5, CSS3, Bootstrap, Python, Flask,
                  Jinja2, SQLAlchemy, PostgreSQL, GoogleMaps API, Openweather
                  API
                </p>
              </div>
            </div>
        ...
        <div className="project-section">
          <div className="project-body">
            ...
            <div className="project-detail">
              <p>
                <em>
                  Social media platform that enables users to instantly post and
