    ...
    return (
      <div className='about'>
        ...
        <div className='about-text'>
          Hi, I'm Jonathan. I'm a software developer born and raised in San Francisco. Ever since I was little, I have been fascinated by how new technologies are constantly being developed. This curiosity for technology has inevitably led to my ever growing collection of cell phones, laptops, tablets, and many other electronics.
        </div>
        <div className='about-text'>
